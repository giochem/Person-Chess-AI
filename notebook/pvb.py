...
# from model_architecture.minimax import BasicMinimax, AdvantageMinimax, MinimaxNNUE
from model_architecture.nnue_3 import MinimaxNNUE
# Initialize Pygame
pygame.init()
...
board = chess.Board()
ai = MinimaxNNUE(depth=3, path_file=f'./checkpoint/nnue_3_1978880d_512bs_200es_51e.pth')
